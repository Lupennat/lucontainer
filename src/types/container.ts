...
export type ContainerConcreteFunction<T = unknown> = (parameters: CallbackWithContainerParameters) => T;
export type ContainerConcrete<T = unknown> = ContainerConcreteFunction<T> | ContainerNewable<T>;
export type ContainerExtendFunction<T = unknown> = (parameters: CallbackWithContainerInstance) => T;
/**
 * [class, method, static]
 */
...
export type ContainerMethodBindingFunction<T = unknown> = (parameters: CallbackWithContainerInstance) => T;
export type ContainerBeforeResolvingFunction<T = unknown> = (parameters: CallbackWithContainerInstanceParameters) => T;
export type ContainerResolvingFunction<T = unknown> = (parameters: CallbackWithContainerInstance) => T;
export type ContainerAfterResolvingFunction<T = unknown> = (parameters: CallbackWithContainerInstance) => T;
export type ContainerReboundFunction = (parameters: CallbackWithContainerInstance) => void;
